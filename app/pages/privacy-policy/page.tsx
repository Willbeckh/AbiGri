        ...
        <div className="min-h-screen bg-green-50 px-4 sm:px-6 lg:px-8 pt-28">
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-700 mt-4">
              Here are some important definitions to help you understand our
              terms and this Privacy Policy: <strong>AbiGri Solutions</strong>,
              and our relevant affiliates are referred to as “
              <strong>AbiGri</strong>,” “<strong>we</strong>,” “
              <strong>us</strong>,” and “<strong>our</strong>.” Our public
              websites, including{" "}
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside ml-6 mt-2 text-gray-700">
              <li>
                <strong>Your Name</strong>: To personalize your experience on
                our site.
              </li>
              <li>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc list-inside ml-6 mt-2 text-gray-700">
              ...
              <li>
                Provide and personalize our services based on your profile.
              </li>
              <li>Communicate with you, if necessary.</li>
            </ul>
            <p className="text-gray-700 mt-4">
              We do <strong>not</strong> use your information for any purpose
              outside of providing access to our site, nor do we share it with
              any third parties outside those essential to the operation of our
              site.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-700">
              ...
              entities. Any third parties that assist us in providing this
              service (e.g., hosting providers) are bound by confidentiality
              agreements and are only allowed to use your data in connection
              with the services they perform for us.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-700">
              ...
              protect your information. However, no transmission over the
              internet or electronic storage method is 100% secure, so we cannot
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-700">
              ...
              contacting us. You may also disconnect your Google account from
              our website at any time via your Google account settings.
            </p>
          </section>
