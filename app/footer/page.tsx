    ...
    <div className="bg-primary-background lg:p-10 p-8 text-white">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between">
              ...
              <div>
                <small className="flex gap-1 items-center">
                  ...
                  <a href="mailto:info@abigri.com">info@abigri.com</a>
                </small>
              </div>
            </div>
          </div>
      ...
      <div className="w-full flex lg:flex-row justify-between  mt-8 pt-2 border-t-2 border-button text-green-200">
        <div className="flex lg:flex-row flex-col gap-2">
          <Link href="/">&bull; Home</Link>
          <Link href="/about">&bull; About</Link>
          <Link href="/pages/privacy-policy">&bull; Privacy</Link>
        </div>
        <div className="text-sm">
          <span>Abigri &copy;{new Date().getFullYear()}</span>
        </div>
      </div>
    </div>
  );
